...
public class Assignment10 {
	...
	public static void main(String[] args) {
		...
		for (int i =0; i<5; i++){
			...
			int intArr = randNum.nextInt(5)+1; // plus 1 because it starts at 0, & you want numbers 1-5
			numbers[i] = intArr; // assigning the i'th value of the array to the random number generated
